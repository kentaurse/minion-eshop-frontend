...
const Checkbox = ({ checkboxStatus, setCheckboxStatus, label, checkboxIdx }) => {

  return (
    <label className="flex justify-center w-fit gap-x-[10px] h-fit mx-auto">
      <input type="checkbox" className="hidden" onChange={() => { (checkboxIdx != undefined) ? setCheckboxStatus(!checkboxStatus, checkboxIdx) : setCheckboxStatus(!checkboxStatus) }} />
