...
export default function StoreCard({ title, showData }) {
  ...
  return (
    <div className=" w-full bg-white shadow-md flex flex-col items-center rounded-[12px] py-4">
      <p className="text-center mb-4 text-[20px] pt-[15px] font-bold text-gray-500">
        {title}
      </p>
      <div className=" flex overflow-hidden duration-500">
        ...
        >
          ...
          <div className="relative flex flex-col items-center w-fit bg-white bg-clip-border p-3 px-0 text-center  transition-all">
            ...
            <div className="">
              <p className="text-gray-500 text-[24px] p-3 px-0 pt-8  break-words w-52 sm:w-64 ">
                <span className="text-[20px] text-gray-500">Manager:</span>{" "}
                {showData[id].manager}
              </p>
              <p className="text-minionBlue text-[30px] font-bold pb-8 p-3 px-0 break-words w-52 sm:w-64 ">
                {showData[id].name}
              </p>
            </div>
            <div>
          ...
          <div className="sm:pr-[30px] text-[40px]">
            {nextItem === true ? (
              <button onClick={() => next()}>
